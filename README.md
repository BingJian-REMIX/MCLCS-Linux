...
> 主库：https://cnb.cool/RLRS-Studio/MCLCS-Linux ｜ GitHub 镜像：[https://github.com/BingJian-REMIX/MCLCS-Linux（本地经 ghproxy 直接推送，cnb CI 仅构建+测试）。]（https://github.com/BingJian-REMIX/MCLCS-Linux）
