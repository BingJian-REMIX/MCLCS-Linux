...
public static class LocaleManager
{
  ...
  ""tool.saves"": ""存档管理器"",
  ""tool.home"": ""主页"",
  ""tool.home.desc"": ""快速开始：启动游戏、查看游玩统计与智能推荐。"",
  ""tool.versionlist"": ""版本列表"",
  ""tool.versionlist.desc"": ""管理已安装的游戏版本，选择并一键启动。"",
  ""tool.toolbox"": ""工具箱"",
  ""tool.toolbox.desc"": ""全部实用工具的聚合入口，点按卡片直达。"",
  ""tool.devtools"": ""开发工具"",
  ""tool.devtools.desc"": ""Mod 骨架生成、资源包创建器与命令速查表。"",
  ""tool.achievement"": ""成就展示"",
  ""tool.achievement.desc"": ""统计各存档的成就达成与紫色成就数量。"",
  ""tool.annual"": ""年度报告"",
  ""tool.annual.desc"": ""把一年的游玩会话聚合成可分享的年度报告。"",
  ""game.launch"": ""启动游戏"",
  ""game.launch.desc"": ""选择版本与账户，启动 Minecraft。"",
  ""tool.backup"": ""备份管理器"",
  ...
  ""tool.home"": ""Home"",
  ""tool.home.desc"": ""Quick start: launch the game, view play stats and recommendations."",
  ""tool.versionlist"": ""Version List"",
  ""tool.versionlist.desc"": ""Manage installed game versions, pick and launch."",
  ""tool.toolbox"": ""Toolbox"",
  ""tool.toolbox.desc"": ""Aggregated entry for all utility tools; tap a card to jump."",
  ""tool.devtools"": ""Dev Tools"",
  ""tool.devtools.desc"": ""Mod scaffold generator, resource pack creator and command cheat-sheet."",
  ""tool.achievement"": ""Achievements"",
  ""tool.achievement.desc"": ""Per-save achievement completion and purple (challenge) counts."",
  ""tool.annual"": ""Annual Report"",
  ""tool.annual.desc"": ""Aggregate a year of play sessions into a shareable annual report."",
  ""game.launch"": ""Launch"",
  ""game.launch.desc"": ""Pick a version and account, then launch Minecraft."",
