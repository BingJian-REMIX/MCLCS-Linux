...
/// 封面图走外联 URL（<see cref="IconUrl"/>），由 <see cref="Controls.ExternalIcon"/> 异步加载并缓存，
/// <see cref="FallbackToken"/> 指定加载失败时的占位（对应 Resources/Icons 文件名）。
/// </summary>
public class DownloadCardItem
{
    ...
    /// <summary>来源：Modrinth / PixelMap / Minecraft。</summary>
